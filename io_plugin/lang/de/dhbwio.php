...
$string['appbar_submitted']      = 'Eingereicht';
$string['appbar_under_review']   = 'In Prüfung';
$string['appbar_result']         = 'Ergebnis';
$string['appbar_accepted']       = 'Angenommen';
$string['appbar_rejected']       = 'Abgelehnt';
$string['appbar_nachzureichen']  = 'Nachzureichen';
$string['nav_fristen']                    = 'Fristen';
$string['nav_learningagreement']          = 'Dateien';
$string['la_upload_title']                = 'Learning Agreement hochladen';
...
$string['la_no_upload_yet']               = 'Du hast noch keine Datei hochgeladen.';
$string['la_current_status']              = 'Aktueller Status';
$string['la_uploaded_file']               = 'Hochgeladene Datei';
$string['la_no_submissions']              = 'Es wurden noch keine Dateien eingereicht.';
$string['la_col_student']                 = 'Studierender';
$string['la_col_file']                    = 'Datei';
$string['la_col_submitted']               = 'Eingereicht am';
$string['la_col_status']                  = 'Status';
$string['la_status_pending']              = 'Ausstehend';
$string['la_status_approved']             = 'Genehmigt';
$string['la_status_rejected']             = 'Abgelehnt';
$string['la_comment_label']               = 'Kommentar (für Studierenden sichtbar)';
$string['la_save_review']                 = 'Bewertung speichern';
$string['la_review_btn']                  = 'Prüfen';
$string['la_review_saved']                = 'Bewertung gespeichert.';
$string['filearea_learning_agreements']   = 'Learning Agreements';
...
$string['alert_rejected']                 = 'Deine Bewerbung wurde leider <strong>abgelehnt</strong>. Das IO hat eine Rückmeldung hinterlassen – bitte schau dir deine Bewerbung an.';
$string['alert_accepted']                 = 'Deine Bewerbung wurde <strong>angenommen</strong>! Das IO hat Hinweise für dich hinterlassen – bitte schau dir deine Bewerbung an.';
$string['alert_nachzureichen']            = 'Das IO hat Unterlagen zum Nachreichen angefordert. Bitte lade die fehlenden Dokumente im Tab <strong>Dateien</strong> hoch.';
$string['status_nachzureichen']           = 'Nachzureichen';
$string['la_la_btn']                      = 'Learning Agreement hochladen';
$string['la_other_btn']                   = 'Andere Dokumente hochladen';
$string['la_moodle_upload_btn']           = 'Dokument über Moodle hochladen';
$string['la_other_upload_title']          = 'Andere Dokumente hochladen';
$string['la_other_upload_success']        = 'Dokument erfolgreich hochgeladen.';
$string['la_col_doctype']                 = 'Dokumenttyp';
$string['la_doctype_learning_agreement']  = 'Learning Agreement';
$string['la_doctype_other_document']      = 'Andere';
$string['la_doc_history']                 = 'Eingereichte Dokumente';
$string['la_col_uploaded']                = 'Hochgeladen am';
$string['la_col_comment']                 = 'Kommentar / Status';
$string['rejection_reason_required']       = 'Bei einer Ablehnung muss ein Kommentar als Begründung angegeben werden.';
$string['nachzureichen_reason_required']   = 'Beim Status „Nachzureichen" muss ein Kommentar angegeben werden, der beschreibt, welche Unterlagen fehlen.';
$string['la_delete_confirm']               = 'Dokument wirklich löschen?';
$string['alert_open_application']         = 'Bewerbung öffnen →';
...
$string['template_type_lang_exists'] = 'Eine Vorlage dieses Typs und dieser Sprache existiert bereits.';
$string['email_template_name'] = 'Vorlagenname';
$string['email_template_type'] = 'Vorlagentyp';
$string['email_template_subject'] = 'Betreff';
$string['email_template_body'] = 'E-Mail-Text';
$string['email_template_body_help'] = 'Geben Sie den E-Mail-Text ein. Sie können HTML-Formatierung und Vorlagenvariablen wie {STUDENT_NAME} verwenden.';
$string['email_template_enabled'] = 'Aktiviert';
$string['email_template_enabled_desc'] = 'Diese Vorlage für den automatischen E-Mail-Versand aktivieren';
$string['template_language'] = 'Vorlagensprache';
$string['template_language_help'] = 'Wählen Sie die Sprache für diese E-Mail-Vorlage. Jeder Vorlagentyp kann Versionen in verschiedenen Sprachen haben.';
...
$string['email_template_subject_help'] = 'Die Betreffzeile für E-Mails, die mit dieser Vorlage versendet werden. Sie können Variablen wie {STUDENT_NAME} verwenden.';
$string['email_template_body_help'] = 'Der Inhalt der E-Mail. Sie können HTML-Formatierung und Variablen wie {STUDENT_NAME}, {SEMESTER} usw. verwenden.';
$string['email_template_enabled_help'] = 'Aktivieren Sie diese Vorlage für den Versand von Benachrichtigungen';
$string['template_language_help'] = 'Die Sprache, in der diese E-Mail-Vorlage verfasst ist. Benutzer erhalten E-Mails in ihrer bevorzugten Sprache, falls verfügbar.';
$string['standard_variables'] = 'Standard-Variablen';
$string['dataform_variables'] = 'Dataform-Variablen';
$string['variable_student_email'] = 'E-Mail-Adresse des Studierenden';
$string['variable_first_wish'] = 'Erstwunsch-Universität des Studierenden';
...
$string['template_type_lang_exists'] = 'Eine Vorlage für diesen Typ und diese Sprache existiert bereits';
$string['missing_required_variables'] = 'Die folgenden erforderlichen Variablen fehlen im E-Mail-Text: {$a}';
