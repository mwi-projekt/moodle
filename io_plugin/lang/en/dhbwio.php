...
$string['dataform_overview_view'] = 'Overview View';
$string['dataform_overview_view_help'] = 'Select the DataForm view to use for the Students application overview';
$string['dataform_entry_view'] = 'Entry View';
$string['dataform_entry_view_help'] = 'Select the DataForm view to use for individual application entry per Student';
$string['no_view_selected'] = 'No view selected';
...
$string['appbar_submitted']      = 'Submitted';
$string['appbar_under_review']   = 'Under Review';
$string['appbar_result']         = 'Result';
$string['appbar_accepted']       = 'Accepted';
$string['appbar_rejected']       = 'Rejected';
$string['appbar_nachzureichen']  = 'Documents Required';
$string['nav_myapplications'] = 'My Applications';
$string['nav_fristen']                    = 'Deadlines';
$string['nav_learningagreement']          = 'Files';
$string['la_upload_title']                = 'Upload Learning Agreement';
...
$string['la_no_upload_yet']               = 'You have not uploaded a document yet.';
$string['la_current_status']              = 'Current status';
$string['la_uploaded_file']               = 'Uploaded file';
$string['la_no_submissions']              = 'No documents have been submitted yet.';
$string['la_col_student']                 = 'Student';
$string['la_col_file']                    = 'File';
$string['la_col_submitted']               = 'Submitted on';
$string['la_col_status']                  = 'Status';
$string['la_status_pending']              = 'Pending';
$string['la_status_approved']             = 'Approved';
$string['la_status_rejected']             = 'Rejected';
$string['la_comment_label']               = 'Comment (visible to student)';
$string['la_save_review']                 = 'Save review';
$string['la_review_btn']                  = 'Review';
$string['la_review_saved']                = 'Review saved.';
...
$string['alert_rejected']                 = 'Unfortunately, your application has been <strong>rejected</strong>. The IO has left feedback – please review your application.';
$string['alert_accepted']                 = 'Your application has been <strong>accepted</strong>! The IO has left notes for you – please review your application.';
$string['alert_nachzureichen']            = 'The IO has requested additional documents. Please upload the missing files in the <strong>Files</strong> tab.';
$string['status_nachzureichen']           = 'Documents Required';
$string['la_la_btn']                      = 'Upload Learning Agreement';
$string['la_other_btn']                   = 'Upload Other Documents';
$string['la_moodle_upload_btn']           = 'Upload Document via Moodle';
$string['la_other_upload_title']          = 'Upload Other Documents';
$string['la_other_upload_success']        = 'Document uploaded successfully.';
$string['la_col_doctype']                 = 'Document Type';
$string['la_doctype_learning_agreement']  = 'Learning Agreement';
$string['la_doctype_other_document']      = 'Other';
$string['la_doc_history']                 = 'Submitted Documents';
$string['la_col_uploaded']                = 'Uploaded on';
$string['la_col_comment']                 = 'Comment / Status';
$string['rejection_reason_required']       = 'A comment explaining the reason for rejection is required.';
$string['nachzureichen_reason_required']   = 'A comment describing which documents are missing is required when setting status to "Documents Required".';
$string['la_delete_confirm']               = 'Really delete this document?';
$string['alert_open_application']         = 'Open application →';
...
$string['variable_application_overview_link'] = 'Link to applications overview page';
$string['variable_application_entry_link'] = 'Link to specific application entry';
